...
on_chroot << EOF
curl https://s3-ap-southeast-2.amazonaws.com/amazon-ssm-ap-southeast-2/latest/debian_arm/amazon-ssm-agent.deb -o /root/amazon-ssm-agent.deb
dpkg -i /root/amazon-ssm-agent.deb
rm /root/amazon-ssm-agent.deb
